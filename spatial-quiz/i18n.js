/* Spatial Transcriptomics Quiz · i18n
 * 與 ../i18n.js 共用 localStorage key 'st_lang'
 * 切換語言能跨頁面（教學頁、references、quiz）同步。
...
(function(){
  ...
  const STR = {
    appTitle:        { zh:"🗺️ Spatial Transcriptomics 互動考題", en:"🗺️ Spatial Transcriptomics Interactive Quiz" },
    ...
    rangeAll:        { zh:"全部 15 個章節", en:"All 15 chapters" },
    ...
    quizAllChapters: { zh:"Spatial Transcriptomics 互動考題（全部章節）", en:"Spatial Transcriptomics Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"Spatial Transcriptomics 互動考題", en:"Spatial Transcriptomics Interactive Quiz" },
  ...
  document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if(host && !document.getElementById('langToggle')){
      ...
      btn.style.cssText = 'background:#fff;color:#5b3e96;border:1px solid rgba(255,255,255,.5);border-radius:999px;padding:5px 14px;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit;white-space:nowrap';
